...
###Settings####
TC_server = 'http://test.example.com:5055'  #URL with portsetting OSMand protocol
url = 'http://test.example.com'             #URL voor API (= website url  traccar: normal:. <ip>:8082 
Traccar_user = 'userTC'                     #User for traccar (with devices for interface)
Traccar_password = 'pasTC'                  #User pass
OpenSky_user = 'userOS'
OpenSky_Password = 'passOS'		    #Can be Empty (update max 1x 10 sec, with user 1x 5 sec)
update  = 15                                #seconds
### read TC devices.
TCupdate = 0
